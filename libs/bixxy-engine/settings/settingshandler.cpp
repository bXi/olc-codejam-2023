...
void Settings::_saveSettings() const
{
	...
	ini["Video"]["Width"] = TextFormat("%i", resWidth);
	ini["Video"]["Height"] = TextFormat("%i", resHeight);

	ini["Audio"]["Mastervolume"] = TextFormat("%i", static_cast<int>(masterVolume * 100));
	ini["Audio"]["Effectsvolume"] = TextFormat("%i", static_cast<int>(effectsVolume * 100));
	ini["Audio"]["Musicvolume"] = TextFormat("%i", static_cast<int>(musicVolume * 100));
